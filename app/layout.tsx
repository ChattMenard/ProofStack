...
export default function RootLayout({ children }: { children: ReactNode }) {
  return (
    <html lang="en">
      ...
      <body className="bg-forest-950 text-forest-50 dark:bg-forest-950 dark:text-forest-50 relative">
        <PostHogProvider>
          {/* Sticky Header with Backdrop Blur */}
          <header className="sticky top-0 z-50 bg-forest-950/80 dark:bg-forest-950/80 backdrop-blur-lg border-b border-forest-800/50 dark:border-forest-800/50 relative">
