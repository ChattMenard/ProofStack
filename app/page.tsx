    ...
    <div className="space-y-20 min-h-screen">
      ...
      <section className="text-center space-y-8 pt-12 pb-8 relative">
        ...
        <div className="space-y-6">
          ...
          {/* Main Headline */}
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-forest-50 light:text-gray-900 leading-tight px-4">
            Turn Your Skills Into
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-sage-400 to-earth-400 light:from-sage-500 light:to-earth-500 block mt-2 animate-gradient">
              Verified Proof
            </span>
          </h1>
          
          {/* Subheadline */}
          <p className="text-lg md:text-xl text-forest-200 light:text-gray-700 max-w-3xl mx-auto leading-relaxed px-4">
            Upload your code, projects, or achievements and get <span className="text-sage-400 light:text-sage-600 font-semibold">AI-powered skill extraction</span> with cryptographic verification. Build a portfolio that employers can <span className="text-sage-400 light:text-sage-600 font-semibold">trust</span>.
          </p>

          {/* Feature Pills */}
          <div className="flex flex-wrap justify-center gap-3 pt-4">
            <span className="px-4 py-2 bg-forest-900/50 light:bg-gray-100 border border-forest-700 light:border-gray-300 rounded-full text-sm text-forest-300 light:text-gray-800 backdrop-blur-sm">
              🤖 AI-Powered
            </span>
            <span className="px-4 py-2 bg-forest-900/50 light:bg-gray-100 border border-forest-700 light:border-gray-300 rounded-full text-sm text-forest-300 light:text-gray-800 backdrop-blur-sm">
