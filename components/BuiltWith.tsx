...
/**
 * Built With Component - Optimized
...
export default function BuiltWith() {
  const services = [
    ...
    {
      name: 'Supabase',
      logo: 'https://supabase.com/dashboard/_next/image?url=%2Fdashboard%2Fimg%2Fsupabase-logo.png&w=128&q=75',
      url: 'https://supabase.com',
      category: 'Infrastructure',
      className: 'dark:brightness-0 dark:invert' // Simplified theme handling
    },
    {
      name: 'Cloudinary',
    ...
    },
    {
      ...
      className: 'light:invert' // Simplified GitHub logo handling
    },
    {
      name: 'Sentry',
      logo: 'https://sentry-brand.storage.googleapis.com/sentry-logo-white.svg',
      url: 'https://sentry.io',
      category: 'Monitoring'
    },
    {
        ...
        {services.map((service) => (
          ...
          >
            <img
              src={service.logo}
              alt={service.name}
              className={`h-5 md:h-6 object-contain ${service.className || ''}`}
              loading="lazy"
            />
          </a>
        ))}
